...
<head>
    ...
    <title>Deleting a Activity</title>
    <style>
        body {
...
// get the username from the form:
  ...
  $q_activity = "DELETE FROM Activities_in WHERE student_id =? AND activity_name=?";
  $st_activity = $cn->stmt_init();
  $st_activity->prepare($q_activity);
  $st_activity->bind_param("ss", $username, $activityName); // "s" for string
